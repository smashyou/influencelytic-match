...
import { BarChart, LineChart, Sparkles, ShieldCheck, BarChartHorizontalIcon, Network, Link, Users } from 'lucide-react';
import { Card } from '@/components/ui/card';

const Features = () => {
  const [activeFeature, setActiveFeature] = useState(0);
  const featureRefs = Array(4).fill(0).map(() => useRef<HTMLDivElement>(null));
  
  const features = [
    {
      title: "AI-Powered Matching",
      description: "Our intelligent algorithm matches brands with the perfect influencers based on audience demographics, engagement rates, and content style.",
      icon: <Sparkles className="h-6 w-6 text-primary" />,
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    },
    {
      title: "Fraud Detection",
      description: "Detect fake followers and engagement with our sophisticated AI tools to ensure authentic partnerships and maximize ROI.",
      icon: <ShieldCheck className="h-6 w-6 text-primary" />,
      image: "https://images.unsplash.com/photo-1589561084283-930aa7b1ce50?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1469&q=80",
    },
    {
      title: "Performance Analytics",
      description: "Track campaign performance with real-time analytics and insights to understand ROI and optimize future collaborations.",
      icon: <BarChart className="h-6 w-6 text-primary" />,
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    },
    {
      title: "Social Media Integration",
      description: "Seamlessly connect all major social platforms to analyze engagement, audience demographics, and content performance.",
      icon: <Network className="h-6 w-6 text-primary" />,
      image: "https://images.unsplash.com/photo-1554177255-61502b352de3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    },
  ];
      ...
      <div className="container mx-auto px-6">
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`rounded-lg p-2 ${activeFeature === index ? 'bg-primary/10' : 'bg-secondary'}`}>
                      {feature.icon}
                    </div>
                    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          <FeatureHighlight 
            ...
            description="Connect your social accounts, get discovered by brands, and receive fair compensation for your content."
          />
          <FeatureHighlight 
