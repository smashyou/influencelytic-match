// backend/routes/brands.js - COMPLETED Brand Management Routes
...
// Get brand profile
router.get('/profile', requireRole(['brand']), async (req, res) => {
  try {
...
router.put('/profile', requireRole(['brand']), async (req, res) => {
  try {
    const { 
      first_name, 
      last_name, 
  ...
  try {
    ...
    await supabase
      ...
      .insert({
        ...
        message: 'You have been invited to participate in a campaign',
