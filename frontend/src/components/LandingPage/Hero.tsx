    ...
    <div ref={containerRef} className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-32 pb-24 md:pt-40 md:pb-32 relative">
        <div className="text-center max-w-4xl mx-auto space-y-8">
          ...
          <h1
            className="heading-1 animate-fade-up"
            style={{ animationDelay: "0.1s" }}
          >
            <span className="block">Connect Businesses with</span>
            <span className="animated-gradient-text">Perfect Influencers</span>
          </h1>

          {/* Subtitle with staggered animation */}
          <p
            className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto animate-fade-up"
            style={{ animationDelay: "0.2s" }}
          >
            Leverage AI to match businesses with influencers based on audience
            demographics, detect fake followers, and optimize pricing for
            successful partnerships.
          </p>

          {/* CTA buttons with hover effects */}
          <div
            className="flex flex-col sm:flex-row gap-4 justify-center mt-8 animate-fade-up"
          ...
          >
            <p className="text-sm text-muted-foreground mb-4">
              Trusted by top brands and influencers
            </p>
      ...
      <div
        className="absolute top-1/4 -left-64 w-96 h-96 bg-primary/5 rounded-full blur-3xl animate-float"
        style={{ animationDelay: "0s" }}
      />
      <div
        className="absolute bottom-1/4 -right-64 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-float"
